    ...
    def _ar(self, box: Box) -> Circuit:
        ...
        if box.name == self.masked_token:
            ...
            if n_qubits == 0:
                ...
                for _ in range(n_qubits - 1):
                    circuit @= H
                circuit >>= CX @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ CX
            elif n_qubits == 5:
                circuit = H
                for _ in range(n_qubits - 1):
                    circuit @= H
                circuit >>= CX @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ CX @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ CX
            elif n_qubits == 6:
                circuit = H
                for _ in range(n_qubits - 1):
                    circuit @= H
                circuit >>= CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ CX @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit)  @ CX @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ CX
            elif n_qubits == 7:
                circuit = H
                for _ in range(n_qubits - 1):
                    circuit @= H
                circuit >>= CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                ...
                for _ in range(n_qubits - 1):
                    circuit @= H
                circuit >>= CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ CX @ Id(qubit) @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ CX @ Id(qubit) @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ CX @ Id(qubit)
                circuit >>= Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ Id(qubit) @ CX
            '''else:
                # Hadamard Layer
                circuit = H
                for _ in range(n_qubits-1):
