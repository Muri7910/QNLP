            ...
            if n_qubits == 0:
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                gate_sequence[4] @ gate_sequence[5] @ gate_sequence[6] @ gate_sequence[7] @ \
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                gate_sequence[4] @ gate_sequence[5] @ gate_sequence[6] @ gate_sequence[7] @ \
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                gate_sequence[4] @ gate_sequence[5] @ gate_sequence[6] @ gate_sequence[7] @ \
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                gate_sequence[4] @ gate_sequence[5] @ gate_sequence[6] @ gate_sequence[7] @ \
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ gate_sequence[16]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[8] @ gate_sequence[9] @ gate_sequence[10] @ gate_sequence[11] @ \
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19] @ \
                                gate_sequence[20] @ gate_sequence[21]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19] @ \
                                gate_sequence[20] @ gate_sequence[21] @ gate_sequence[22]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[12] @ gate_sequence[13] @ gate_sequence[14] @ gate_sequence[15] @ \
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19] @ \
                                gate_sequence[20] @ gate_sequence[21] @ gate_sequence[22] @ gate_sequence[23]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19] @ \
                                gate_sequence[20] @ gate_sequence[21] @ gate_sequence[22] @ gate_sequence[23] @ \
                                gate_sequence[24] @ gate_sequence[25]
                ...
                for i in range(n_qubits - 1):
                    ...
                    circuit >>= gate_sequence[0] @ gate_sequence[1] @ gate_sequence[2] @ gate_sequence[3] @ \
                                ...
                                gate_sequence[16] @ gate_sequence[17] @ gate_sequence[18] @ gate_sequence[19] @ \
                                gate_sequence[20] @ gate_sequence[21] @ gate_sequence[22] @ gate_sequence[23] @ \
                                gate_sequence[24] @ gate_sequence[25] @ gate_sequence[26]
